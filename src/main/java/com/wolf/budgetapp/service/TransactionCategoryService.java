...
public class TransactionCategoryService {
  ...
  public TransactionCategory getTransactionCategoryByName(String categoryName) {
    TransactionCategory category = transactionCategoryRepository
        ...
        .orElseThrow(
            () -> new EntityNotFoundException("TransactionCategory not found: " + categoryName));
  ...
  public TransactionCategory createTransactionCategory(
  ...
  public TransactionCategory updateTransactionCategory(
      String categoryName, TransactionCategoryDto updatedTransactionCategoryDto) {
    ...
    if (updatedTransactionCategoryDto.getCategoryDescription() != null) {
      transactionCategory.setCategoryDescription(
          updatedTransactionCategoryDto.getCategoryDescription());
    }

    if (updatedTransactionCategoryDto.getCashflowName() != null) {
      CashflowType cashflowType = cashflowTypeRepository
          .findById(updatedTransactionCategoryDto.getCashflowName())
          .orElseThrow(() -> new EntityNotFoundException(
              "CashFlowType not found: " + updatedTransactionCategoryDto.getCashflowName()));
